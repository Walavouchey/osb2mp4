...
int main(int argc, char* argv[]) {
	...
	std::unique_ptr<sb::Storyboard> sb = std::make_unique<sb::Storyboard>(directory, diff, std::pair<unsigned, unsigned>(frameWidth, frameHeight), 0.2f, 0.2f, 1.0f, true, true);
